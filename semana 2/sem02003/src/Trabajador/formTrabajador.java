...
public class formTrabajador extends javax.swing.JFrame {
    ...
    private void btnCalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalActionPerformed
        ...
        trab.setCod(txtCod.getText());
        trab.setNom(txtNom.getText());
        trab.setSb(Double.parseDouble(txtSB.getText()));
        trab.setBon(Double.parseDouble(txtBon.getText()));
        trab.setDes(Double.parseDouble(txtDesc.getText()));
