...
public class Principal {
    ...
    public static void main(String[] args) {
       ...
       /*Docente obj1 = new Docente("Galvez","Ricardo",35,100,40);
        ...
        listar(obj2);
        */        
        int i,n,edad,horas,tarifa,nota1,nota2,nota3,acuA=0,acuD=0;
        String persona,nom,ape;
        double acuS=0,promedio;
        ...
        for (i = 1; i <=n; i++) {
            ...
            if (persona.compareTo("docente")==0){
                ...
                promedio = obj2.calcularPromedio();
        ...
        System.out.println("---------------------REPORTE DE DOCENTES--------------------------");
        System.out.println("EL total de Sueldo de Docentes es "+acuS);
        
        
        System.out.println("---------------------REPORTE DE ALUMNOS APROBADOS Y DESAPROBADOS--------------------------");
        System.out.println("La cantidad de Aprobados es de " + acuA);
        System.out.println("La cantidad de Desaprobados es de " + acuD);
    ...
    static void listar(Persona x){
        ...
        if( x instanceof Docente){
            ...
            pro = ((Alumno)x).calcularPromedio();
            
            
            System.out.println("Promedio: "+" "+((Alumno)x).calcularPromedio());
